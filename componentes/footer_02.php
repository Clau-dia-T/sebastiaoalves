        ...
        <div class="row">
            <div class="col-12 p-0">
                ...
                <div class="row caixacontactos">
                    <!--Direita-->
                    <div class="col-12 col-md-7 d-none d-md-block direita">
                    ...
                    <div class="col-12 col-md-7 p-0 caixaimgfundo">
                        <a href="https://www.livroreclamacoes.pt/" target="_blank"><img class="imgfundo01" src="<?= $url_public; ?>Imagens/livroreclamacoes.svg" alt="livro_reclamacoes"></a>
                        <a href="https://sebastiaoalves.com/ralc"><img class="imgfundo02" src="<?= $url_public; ?>Imagens/ralc.svg" alt="RALC"></a>
                    </div>
